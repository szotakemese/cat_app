...
class GetFavouriteCats implements UseCase<List<Cat>, String> {
  final CatAppRepository catAppRepository;

  GetFavouriteCats(this.catAppRepository);

  @override
  Future<Either<Failure, List<Cat>>> call(String userId) async {
    return await catAppRepository.getFavouriteCats(userId);
  }
}
